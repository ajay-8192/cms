...
const ProfileDashboard = () => {
  ...
  return (
    <div className="w-full">
      <header className="border-b py-4 pl-12 font-semibold text-xl flex items-center sticky top-0 bg-primary-white">
        <span className="material-icons" style={{ color: "#1f2d5a" }}>
          badge
        </span>
        <div className="ml-3">User Details</div>
      </header>
      <section className="mt-12 border shadow rounded-xl border-primary-blue w-3/5 mx-auto p-8">
      ...
      <section className="border shadow rounded-xl border-primary-blue w-3/5 mt-6 mx-auto p-8">
        ...
        <button
          className="mt-8 border-2 px-4 py-2 rounded-lg border-red-500 active:bg-red-900 active:text-primary-white active:border-red-900"
